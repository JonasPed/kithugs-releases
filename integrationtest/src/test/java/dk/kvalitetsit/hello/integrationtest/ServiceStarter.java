...
public class ServiceStarter {
    ...
    private static final Logger serviceLogger = LoggerFactory.getLogger("kithugs-releases");
    ...
    public GenericContainer startServicesInDocker() {
        ...
        var resourcesContainerName = "kithugs-releases-resources";
        ...
        if (resourcesRunning) {
            ...
            service = new GenericContainer<>("local/kithugs-releases-qa:dev")
        ...
        service.withNetwork(dockerNetwork)
                .withNetworkAliases("kithugs-releases")
